...
class HybridDiT_AdaLN(nn.Module):
    ...
    def forward(self, x, x_t, t, y):
        ...
        c = t_embed + y_embed
        c = torch.cat([torch.zeros_like(c), c], dim=1)
...
if __name__ == "__main__":
    ...
    config = OmegaConf.load("config/overfit_1024/with_condition.yaml")
