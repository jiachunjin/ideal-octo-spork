    ...
    while not training_done:
        for batch in dataloader:
            with accelerator.accumulate([model]):
                ...
                x_t, target, t = model.block_wise_noising(x_clip)
                pred = model(x_clip, x_t, t, hidden_states)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="config/overfit_1024/with_condition.yaml")
